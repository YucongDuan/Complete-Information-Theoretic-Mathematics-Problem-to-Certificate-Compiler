# CITM Forge · Mathematical certificates — practical guide / 使用导读

[Project README](README.md) · [Detailed project record](https://github.com/YucongDuan/YucongDuan/blob/main/projects/1344438920.md) · [Research portfolio](https://github.com/YucongDuan)
...
Download the named ZIP, extract it and enter its inner project folder before installing or running the demo.

下载具名ZIP，解压并进入内部项目目录，再安装和运行示例。

[Inspect the entry file / 查看入口文件](DIKWP-CITM-Forge-v1.0.0.zip)
...
Inspect the finite Goldbach example and its remaining proof obligations. / 检查有限范围哥德巴赫示例及剩余证明义务。
